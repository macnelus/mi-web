...
export const getYoutubeApi = async () => {
  const response = await window.gapi.client.request(
    `https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UC-jqp9Jz_9tiGiVVtSiPkmw&order=id&type=video&videoSyndicated=true&key=${REACT_APP_YOUTUBE_API_KEY}`,
  );
